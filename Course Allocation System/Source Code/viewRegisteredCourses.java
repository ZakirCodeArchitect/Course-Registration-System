...
public class viewRegisteredCourses extends JFrame implements ActionListener {
    ...
    viewRegisteredCourses() {
        ...
        JLabel searchlbl = new JLabel("Search by Semester");
        ...
        try {
            conn c = new conn();
            ResultSet rs = c.s.executeQuery("select * from RegisteredCourses");
            while (rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            String query = "select * from RegisteredCourses where Semester='" + csemester.getSelectedItem() + "'";
