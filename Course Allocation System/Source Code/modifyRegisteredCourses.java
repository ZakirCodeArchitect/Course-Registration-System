...
public class modifyRegisteredCourses extends JFrame implements ActionListener {
    ...
    modifyRegisteredCourses(String semester) {
        ...
        try {
            ...
            conn c = new conn();
            String query = "Select * from RegisteredCourses  where Semester = '" + semester + "'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == allocate) {
            ...
            try {
                conn c = new conn();
                String query = "update courses set RegisteredCourses = '" + courseName + "' where Semester = '"
                        + Semester
                        + "'";
                // query
                c.s.executeUpdate(query);
                JOptionPane.showMessageDialog(null, "Registered Course Modified successfully");
                setVisible(false);
                new StudentHome();
